...
namespace ExtraChessTests.Analysis
{
    public class Tests
    {
        ...
        public void PerftStartPos()
        {
            ...
            Assert.AreEqual(1, Perft.PerftSingleThreaded(board, 0));
            Assert.AreEqual(20, Perft.PerftSingleThreaded(board, 1));
            Assert.AreEqual(400, Perft.PerftSingleThreaded(board, 2));
            Assert.AreEqual(8_902, Perft.PerftSingleThreaded(board, 3));
            Assert.AreEqual(197_281, Perft.PerftSingleThreaded(board, 4));
            Assert.AreEqual(4_865_609, Perft.PerftSingleThreaded(board, 5));
        ...
        public void PerftKiwiPete()
        {
            ...
            Assert.AreEqual(1, Perft.PerftSingleThreaded(board, 0));
            Assert.AreEqual(48, Perft.PerftSingleThreaded(board, 1));
            Assert.AreEqual(2_039, Perft.PerftSingleThreaded(board, 2));
            Assert.AreEqual(97_862, Perft.PerftSingleThreaded(board, 3));
            Assert.AreEqual(4_085_603, Perft.PerftSingleThreaded(board, 4));
        ...
        public void PerftPosition3()
        {
            ...
            Assert.AreEqual(1, Perft.PerftSingleThreaded(board, 0));
            Assert.AreEqual(14, Perft.PerftSingleThreaded(board, 1));
            Assert.AreEqual(191, Perft.PerftSingleThreaded(board, 2));
            Assert.AreEqual(2_812, Perft.PerftSingleThreaded(board, 3));
            Assert.AreEqual(43_238, Perft.PerftSingleThreaded(board, 4));
            Assert.AreEqual(674_624, Perft.PerftSingleThreaded(board, 5));
            Assert.AreEqual(11_030_083, Perft.PerftSingleThreaded(board, 6));
        ...
        public void PerftPosition4()
        {
            ...
            Assert.AreEqual(1, Perft.PerftSingleThreaded(board, 0));
            Assert.AreEqual(6, Perft.PerftSingleThreaded(board, 1));
            Assert.AreEqual(264, Perft.PerftSingleThreaded(board, 2));
            Assert.AreEqual(9_467, Perft.PerftSingleThreaded(board, 3));
            Assert.AreEqual(422_333, Perft.PerftSingleThreaded(board, 4));
            Assert.AreEqual(15_833_292, Perft.PerftSingleThreaded(board, 5));
        ...
        public void PerftPosition5()
        {
            ...
            Assert.AreEqual(1, Perft.PerftSingleThreaded(board, 0));
            Assert.AreEqual(44, Perft.PerftSingleThreaded(board, 1));
            Assert.AreEqual(1_486, Perft.PerftSingleThreaded(board, 2));
            Assert.AreEqual(62_379, Perft.PerftSingleThreaded(board, 3));
            Assert.AreEqual(2_103_487, Perft.PerftSingleThreaded(board, 4));
        ...
        public void PerftPosition6()
        {
            ...
            Assert.AreEqual(1, Perft.PerftSingleThreaded(board, 0));
            Assert.AreEqual(46, Perft.PerftSingleThreaded(board, 1));
            Assert.AreEqual(2_079, Perft.PerftSingleThreaded(board, 2));
            Assert.AreEqual(89_890, Perft.PerftSingleThreaded(board, 3));
            Assert.AreEqual(3_894_594, Perft.PerftSingleThreaded(board, 4));
